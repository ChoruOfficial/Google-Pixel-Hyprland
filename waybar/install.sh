...
echo "  ███████╗██╔╝ ██╗╚██████╔╝╚██████╗╚██████╔╝██║  ██║███████╗"
echo "  ╚══════╝╚═╝  ╚═╝ ╚═════╝  ╚═════╝ ╚═════╝ ╚═╝  ╚═╝╚══════╝"
echo -e "         ${PURPLE}PREMIUM SYSTEM DEPLOYMENT v1.3${NC}"
echo -e "${BLUE}==========================================================${NC}"
...
echo -e "\n${YELLOW}󰂖 [1/5] Initializing core dependencies...${NC}"
DEPENDENCIES="waybar swww git nodejs npm rofi ttf-jetbrains-mono-nerd networkmanager bluetoothctl"
(sudo pacman -S --noconfirm --needed $DEPENDENCIES) & spinner
...
echo -e "${CYAN}   The Exocore build is now active on your system.${NC}"
echo -e "${BLUE}==========================================================${NC}"
